...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills and play friendly scrimmages",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["josh@mergington.edu", "mia@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Society": {
        "description": "Prepare scenes and performances for school theater events",
